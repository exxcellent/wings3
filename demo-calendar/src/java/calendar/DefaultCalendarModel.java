...
public class DefaultCalendarModel implements CalendarModel {
    ...
    private Calendar tempCalFrom;
    private Calendar tempCalUntil;
    ...
    public DefaultCalendarModel(TimeZone timeZone, Locale locale) {
        setTimeZone(timeZone);
        setLocale(locale);

        tempCalFrom = Calendar.getInstance(getTimeZone(), getLocale());
        tempCalUntil = Calendar.getInstance(getTimeZone(), getLocale());
    ...
    private void updateVisibleDates() {
        ...
        switch (this.view) {
            ...
            case WEEK:
                ...
                break;
            case WORKWEEK:
                Calendar calendar3 = Calendar.getInstance(getTimeZone(), getLocale());
                ...
                break;
            case DAY:
                Calendar calendar1 = Calendar.getInstance(getTimeZone(), getLocale());
    ...
    private boolean isAppointmentOnDateDay(Appointment appointment, Date date) {
        Calendar calTestDate = Calendar.getInstance(getTimeZone(), getLocale());
        calTestDate.setTime(date);

        Calendar appStartDate = Calendar.getInstance(getTimeZone(), getLocale());
        ...
        Calendar appEndDate = Calendar.getInstance(getTimeZone(), getLocale());
    ...
    public boolean isVisible(Date date) {
        Calendar from = Calendar.getInstance(getTimeZone(), getLocale());
    ...
    public String getUniqueAppointmentID(Date date, Appointment appointmentToGetIDFrom) {
        Calendar tempCal = Calendar.getInstance(getTimeZone(), getLocale());
