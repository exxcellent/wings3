...
public class XSuggestExample extends WingSetPane {
    ...
    private SPanel createXSuggestPanel() {     
        ...
        autoCorrect.addAjaxDocumentListener(new SDocumentAdapter() {            
            public void insertUpdate(SDocumentEvent e) {
                String text = e.getDocument().getText();                
                e.getDocument().setText(text.toUpperCase());
            }            
        });
    ...
    public class CountriesOfTheWorld implements XSuggestDataSource {
        ...
        public List generateSuggestions(String part) {
    ...
    public class StatesOfGermany implements XSuggestDataSource {
        ...
        private void init() {
            ...
            states.add(new State("Baden-W�rttemberg", "DE-BW"));
            ...
            states.add(new State("Th�ringen", "DE-TH"));
        }
            ...
            for (Iterator iter = states.iterator(); iter.hasNext();) {                
                ...
                if (o instanceof State) {
                    ...
                    if (state.name.toLowerCase().startsWith(part.toLowerCase())) {
                        returning.add("<b>"+ state.iso + "</b>" + " "+ state.name);
                        returning.add(state.iso);
                    }
                }
            }
